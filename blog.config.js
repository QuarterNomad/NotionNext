...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Andrew', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '25岁就去流浪', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://andrewcode.top', // 网站地址
